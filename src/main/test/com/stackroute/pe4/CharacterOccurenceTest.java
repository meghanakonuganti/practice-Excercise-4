...
public class CharacterOccurenceTest {
    ...
    public void countOfTheGivenCharacter() {
        int result=occurence.countOfTheGivenCharacter("My name is Meghana",'a');
        assertEquals(3,result);
    }
    @Test
    public void countOfTheGivenCapitalCharacter() {
        int result=occurence.countOfTheGivenCharacter("My name is Meghana",'M');
        assertEquals(1,result);

    }
    @Test
    public void givenACharacterNotInSentence() {
        int result=occurence.countOfTheGivenCharacter("My name is Meghana",'z');
